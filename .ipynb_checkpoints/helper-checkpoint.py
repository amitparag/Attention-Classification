...
# Specify the directory path containing the videos
video_directory = './dataset/learning/slip/split'
    ...
    for root, _, files in os.walk(root_dir):
        for filename in files:
            if filename.endswith('.avi'):
                ...
                video_writer = cv2.VideoWriter(output_video_path, fourcc, 25, target_resolution)
